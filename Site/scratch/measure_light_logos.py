...
with sync_playwright() as p:
    ...
    for vp_name, width in [("Desktop", 1440), ("Tablet", 810), ("Mobile", 390)]:
            ...
            return targets.map(t => {
                ...
                return {
                    ...
                    imgBox: {
                        ...
                        content: imgBoxStyle ? imgBoxStyle.content : null,
                    },
                    img: {
                        src: img ? img.src : null,
                        w: img ? img.offsetWidth : null,
                        h: img ? img.offsetHeight : null,
                    },
                    text: {
                        w: textRect ? Math.round(textRect.width) : null,
                        h: textRect ? Math.round(textRect.height) : null,
                        display: textStyle ? textStyle.display : null,
        ...
        print(f"\n=================== LIGHT MODE: {vp_name} (width: {width}px) ===================")
        pprint.pprint(data)
